...
then
  ...
  lynx --dump "https://google.com/search?&q=site:$1++ext:pdf++ext:doc++ext:xlms" | grep ".pdf|.doc|.xlms" | cut -d "=" -f2 | egrep -v "site" | sed 's/...$//' > arquivo_URLs #vai criar a pasta onde o script rodar
  ...
  exiftool * -ext pdf -ext doc -ext xlms #vai ler todos arq da pasta
